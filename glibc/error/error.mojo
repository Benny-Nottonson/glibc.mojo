...
# @always_inline("nodebug")
# fn vwarn(format: UnsafePointer[c_char], args: va_list):
#     external_call["vwarn", NoneType](format, args)
...
# @always_inline("nodebug")
# fn vwarnx(format: UnsafePointer[c_char], args: va_list):
#     external_call["vwarnx", NoneType](format, args)
...
# @always_inline("nodebug")
# fn verr(status: c_int, format: UnsafePointer[c_char], args: va_list):
#     external_call["verr", NoneType](status, format, args)
...
# @always_inline("nodebug")
# fn verrx(status: c_int, format: UnsafePointer[c_char], args: va_list):
#     external_call["verrx", NoneType](status, format, args)